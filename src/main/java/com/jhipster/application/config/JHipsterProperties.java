...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "JHipsterApplication@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "JHipsterApplication API";

        private String description = "JHipsterApplication API documentation";
