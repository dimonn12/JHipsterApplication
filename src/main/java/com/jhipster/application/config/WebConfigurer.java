...
import com.jhipster.application.web.filter.CachingHttpHeadersFilter;
import com.jhipster.application.web.filter.StaticResourcesProductionFilter;
import com.jhipster.application.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initClusteredHttpSessionFilter(ServletContext servletContext, EnumSet<DispatcherType> disps) {
        ...
        disps = EnumSet.of(DispatcherType.REQUEST,
            DispatcherType.FORWARD,
            DispatcherType.ASYNC,
        ...
        parameters.put("instance-name", "JHipsterApplication");
