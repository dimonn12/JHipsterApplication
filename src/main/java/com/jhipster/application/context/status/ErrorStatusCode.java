...
public enum ErrorStatusCode {
    ...
    INVALID_ENTITY(4000100, "Entity is not valid"),
    ENTITY_ALREADY_HAS_AN_ID(4000101, "Entity already has an id"),
    VALUE_EMPTY(4000102, "Value can't be empty"),
    DATE_EMPTY(4000103, "Date can't be empty"),
    NAME_EMPTY(4000104, "Name can't be empty"),
    EXTERNAL_ID_EMPTY(4000105, "External Id can't be empty"),
    ...
    USER_NOT_FOUND_BY_ACTIVATION_KEY(4040003, "User not found by selected activation key"),
    USER_NOT_FOUND_BY_ID(4040004, "User not found by User Id"),
    USER_NOT_FOUND_BY_RESET_KEY_ID(4040004, "User not found by Reset Key Id"),
